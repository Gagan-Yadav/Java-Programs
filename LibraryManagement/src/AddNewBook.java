...
public class AddNewBook extends javax.swing.JFrame {
    ...
    private void c3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c3ActionPerformed
        ...
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("Bio");c4.addItem("Physics");c4.addItem("Chemistry");
        }
        if(c3.getSelectedItem()=="Arts")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("English");c4.addItem("Hindi");c4.addItem("PE");
        }
        if(c3.getSelectedItem()=="Commerce")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("Accounts");c4.addItem("ECO");c4.addItem("IP");
        }
