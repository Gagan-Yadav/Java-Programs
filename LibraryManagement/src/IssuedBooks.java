...
public class IssuedBooks extends javax.swing.JFrame {
    ...
    private void c1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c1ActionPerformed
        ...
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("Bio");c2.addItem("Physics");c2.addItem("Chemistry");
        }
        if(c1.getSelectedItem()=="Arts")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("English");c2.addItem("Hindi");c2.addItem("PE");
        }
        if(c1.getSelectedItem()=="Commerce")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("Accounts");c2.addItem("ECO");c2.addItem("IP");
        }
    ...
    private void c2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c2ActionPerformed
        ...
        {
            connect();
            query="select * from issued where stream='"+c1.getSelectedItem()+"' and class='"+c2.getSelectedItem()+"';";
